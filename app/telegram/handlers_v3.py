...
async def cmd_start_v3(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    await update.message.reply_text(
        ...
        "<code>/mekanik THYAO</code> — Daily→4H→15dk JSON mekanik setup\n"
...
async def cmd_komutlar(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    await update.message.reply_text(
        ...
        "/mekanik THYAO — kapanmış mum JSON setup: Daily→4H→15dk, seviye/OB/FVG/SL-TP\n"
        "/mekanik_kurallar — retest/sweep, risk ve iptal kuralları\n\n"
